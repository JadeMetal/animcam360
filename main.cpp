...
extern "C" DLLEXPORT bool APIENTRY SKSEPlugin_Query(const SKSE::QueryInterface* a_skse, SKSE::PluginInfo* a_info)
{
	try {
...
#else
		auto path = logger::log_directory() / "Animcam360Plugin.log"sv;
		...
		logger::info("Animcam360 Plugin v{}"sv, MYFP_VERSION_VERSTRING);

		a_info->infoVersion = SKSE::PluginInfo::kVersion;
		a_info->name = "Animcam360";
...
{
	try {
		logger::critical("MyFirstPlugin loaded");
	...
	CombatFreeRotateCamera::Install();
